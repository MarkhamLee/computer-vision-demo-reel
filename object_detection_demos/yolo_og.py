...
class ObjectDetection:
    ...
    It uses yolo5 pretrained model to make inferences and opencv2
    to manage frames.
    Included Features:
    ...
    def __init__(self, input_file, out_file="Labeled_Video.avi"):
        """
        :param input_file: provide youtube url which will act as
        input for the model. param out_file: name of a existing file,
        or a new file in which to write the output.
        return: void
        """
    ...
    def get_video_from_file(self):
        """
        Function creates a streaming object to read the video from
        the file frame by frame. param self:  class object
    ...
    def score_frame(self, frame):
        ...
        labels, cord = results.xyxyn[0][:, -1].to('cpu').numpy(), \
    ...
    def plot_boxes(self, results, frame):
        ...
        for i in range(n):
            ...
            cv2.putText(frame, f"Detections: {n}", (30, 30),
    ...
    def __call__(self):
        ...
        while True:
            ...
            if fc == 10:
                ...
                print(f"Frames Per Second : {fps} || Percentage Parsed : {per_com}")  # noqa: E501
            out.write(frame)
...
a = ObjectDetection("videos/cars_pedestrians.mp4",
                    "outputvideo/output_001.avi")
a()
